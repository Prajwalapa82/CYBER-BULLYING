...
<body background="<%=request.getContextPath()%>/images/catword.jpg">
...
<form action="<%=request.getContextPath()%>/tweet/addCatWord.do" method="post"  >
	...
	<div align="center">
		...
		<tr>
			<td><label>Enter the Word to be added:</label> </td>
