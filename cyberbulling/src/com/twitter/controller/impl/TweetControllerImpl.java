...
public class TweetControllerImpl implements TweetController {
	...
	@Override
	@RequestMapping(value = "/viewClassifier.do", method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@Override
	@RequestMapping(value = "/viewCountsForClassifier.do", method = { RequestMethod.POST,
			RequestMethod.GET })
	public @ResponseBody AJAXResponse viewNoOfClassifier(HttpServletRequest request) {
		...
		try {
			...
			ajaxResponse.setStatus(true);
			ajaxResponse.setModel(tweets);
			ajaxResponse.setMessage(TwitterConstants.Message.CLASSIFY_COUNT_SUCESS);
			return ajaxResponse;
